...
extern PyObject *global_constants[109];
// ()
...
// 'lower'
#define const_str_plain_lower global_constants[55]
// '/'
#define const_str_slash global_constants[56]
// '\\'
#define const_str_backslash global_constants[57]
// 'path'
#define const_str_plain_path global_constants[58]
// 'basename'
#define const_str_plain_basename global_constants[59]
// 'dirname'
#define const_str_plain_dirname global_constants[60]
// 'abspath'
#define const_str_plain_abspath global_constants[61]
// 'isabs'
#define const_str_plain_isabs global_constants[62]
// 'normpath'
#define const_str_plain_normpath global_constants[63]
// 'exists'
#define const_str_plain_exists global_constants[64]
// 'isdir'
#define const_str_plain_isdir global_constants[65]
// 'isfile'
#define const_str_plain_isfile global_constants[66]
// 'listdir'
#define const_str_plain_listdir global_constants[67]
// 'stat'
#define const_str_plain_stat global_constants[68]
// 'lstat'
#define const_str_plain_lstat global_constants[69]
// 'close'
#define const_str_plain_close global_constants[70]
// 'getattr'
#define const_str_plain_getattr global_constants[71]
// '__cached__'
#define const_str_plain___cached__ global_constants[72]
// 'print'
#define const_str_plain_print global_constants[73]
// 'end'
#define const_str_plain_end global_constants[74]
// 'file'
#define const_str_plain_file global_constants[75]
// 'bytes'
#define const_str_plain_bytes global_constants[76]
// '.'
#define const_str_dot global_constants[77]
// '_'
#define const_str_underscore global_constants[78]
// '__loader__'
#define const_str_plain___loader__ global_constants[29]
// '__annotations__'
#define const_str_plain___annotations__ global_constants[79]
// 'send'
#define const_str_plain_send global_constants[80]
// 'throw'
#define const_str_plain_throw global_constants[81]
// 'site'
#define const_str_plain_site global_constants[82]
// 'type'
#define const_str_plain_type global_constants[83]
// 'len'
#define const_str_plain_len global_constants[84]
// 'range'
#define const_str_plain_range global_constants[34]
// 'repr'
#define const_str_plain_repr global_constants[85]
// 'int'
#define const_str_plain_int global_constants[86]
// 'iter'
#define const_str_plain_iter global_constants[87]
// '__spec__'
#define const_str_plain___spec__ global_constants[88]
// '_initializing'
#define const_str_plain__initializing global_constants[89]
// 'parent'
#define const_str_plain_parent global_constants[90]
// 'types'
#define const_str_plain_types global_constants[91]
// 'ascii'
#define const_str_plain_ascii global_constants[92]
// 'punycode'
#define const_str_plain_punycode global_constants[93]
// '__main__'
#define const_str_plain___main__ global_constants[94]
// 'as_file'
#define const_str_plain_as_file global_constants[95]
// 'register'
#define const_str_plain_register global_constants[96]
// '__class_getitem__'
#define const_str_plain___class_getitem__ global_constants[97]
// 'reconfigure'
#define const_str_plain_reconfigure global_constants[98]
// 'encoding'
#define const_str_plain_encoding global_constants[99]
// 'line_buffering'
#define const_str_plain_line_buffering global_constants[100]
// '__match_args__'
#define const_str_plain___match_args__ global_constants[101]
// '__aenter__'
#define const_str_plain___aenter__ global_constants[102]
// '__aexit__'
#define const_str_plain___aexit__ global_constants[103]
// 'split'
#define const_str_plain_split global_constants[104]
// 'fileno'
#define const_str_plain_fileno global_constants[105]
// 'args'
#define const_str_plain_args global_constants[106]
#endif
