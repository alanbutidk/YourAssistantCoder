...
assert(mod_consts_hash[3] == DEEP_HASH(tstate, mod_consts.const_str_plain_hazmat));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_hazmat);
...
assert(mod_consts_hash[9] == DEEP_HASH(tstate, mod_consts.const_str_digest_6256eb2942a3906189630d8bae56357f));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_6256eb2942a3906189630d8bae56357f);
assert(mod_consts_hash[10] == DEEP_HASH(tstate, mod_consts.const_str_digest_f6a5cc0cba3d9495847f9ca96ef756af));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_f6a5cc0cba3d9495847f9ca96ef756af);
}
#endif
...
tmp_assattr_target_1 = module_var_accessor_cryptography$hazmat$__spec__(tstate);
...
tmp_assattr_target_2 = module_var_accessor_cryptography$hazmat$__spec__(tstate);
...
tmp_assattr_value_3 = module_var_accessor_cryptography$hazmat$__path__(tstate);
...
tmp_assattr_target_3 = module_var_accessor_cryptography$hazmat$__spec__(tstate);
...
UPDATE_STRING_DICT1(moduledict_cryptography$hazmat, (Nuitka_StringObject *)mod_consts.const_str_plain_annotations, tmp_assign_source_5);
}
