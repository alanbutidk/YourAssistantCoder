/* Generated code for Python module 'anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events'
...
/* The "module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events" is a Python object pointer of module type.
 *
...
PyObject *module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
PyDictObject *moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
PyObject *const_str_digest_4892cafcbff741f4695417859216a6af;
PyObject *const_str_digest_5defd43d0c78461018f49070fcc915ff;
} mod_consts;
...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, (PyObject **)&mod_consts, UN_TRANSLATE("anthropic.types.beta.sessions.beta_managed_agents_stream_session_thread_events"));
...
mod_consts_hash[111] = DEEP_HASH(tstate, mod_consts.const_str_digest_1c85da38dd09ccf517e65697df6a701b);
...
mod_consts_hash[114] = DEEP_HASH(tstate, mod_consts.const_str_digest_4892cafcbff741f4695417859216a6af);
mod_consts_hash[115] = DEEP_HASH(tstate, mod_consts.const_str_digest_5defd43d0c78461018f49070fcc915ff);
#endif
    }
}
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events(PyThreadState *tstate) {
...
assert(mod_consts_hash[111] == DEEP_HASH(tstate, mod_consts.const_str_digest_1c85da38dd09ccf517e65697df6a701b));
...
assert(mod_consts_hash[114] == DEEP_HASH(tstate, mod_consts.const_str_digest_4892cafcbff741f4695417859216a6af));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_4892cafcbff741f4695417859216a6af);
assert(mod_consts_hash[115] == DEEP_HASH(tstate, mod_consts.const_str_digest_5defd43d0c78461018f49070fcc915ff));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_5defd43d0c78461018f49070fcc915ff);
}
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$Annotated(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        CHECK_OBJECT_X(cache_value);
        result = cache_value;
    } else {
        dict_version = moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag;

        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Annotated);
        cache_value = result;
    }
#else
    ...
    PyDictKeysObject *dk = moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_keys;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Annotated);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentCustomToolUseEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentCustomToolUseEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentCustomToolUseEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMCPToolResultEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolResultEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolResultEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMCPToolUseEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolUseEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolUseEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMessageEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMessageEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMessageEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThinkingEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentThinkingEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentThinkingEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadContextCompactedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e328354439fe86c13e6c5cffe6a79707);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e328354439fe86c13e6c5cffe6a79707);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadMessageReceivedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_8aa8484df48f880159babc856f073325);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_8aa8484df48f880159babc856f073325);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadMessageSentEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_53b65cba1e561c6df7f51f1093dca70d);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_53b65cba1e561c6df7f51f1093dca70d);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentToolResultEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolResultEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolResultEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentToolUseEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolUseEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolUseEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionDeletedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionDeletedEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionDeletedEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionErrorEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionErrorEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionErrorEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusIdleEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionStatusIdleEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionStatusIdleEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusRescheduledEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_79208f99f42387dedaa503f910cf801e);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_79208f99f42387dedaa503f910cf801e);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusRunningEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7bd78a3f07d54c8e773e97b2b33d4855);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7bd78a3f07d54c8e773e97b2b33d4855);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusTerminatedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_a39975e914a6a86ba3153b197792b326);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_a39975e914a6a86ba3153b197792b326);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadCreatedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_680985bd76c009f9f484b2ca1ee7179b);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_680985bd76c009f9f484b2ca1ee7179b);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusIdleEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e0e15641e9785d45266c86e750f17f58);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e0e15641e9785d45266c86e750f17f58);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusRescheduledEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_80411456df379e8767e34326f63b4233);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_80411456df379e8767e34326f63b4233);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusRunningEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7c5e88ab7f33db0dd8ffb0cc94d6c2ac);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7c5e88ab7f33db0dd8ffb0cc94d6c2ac);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusTerminatedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_134a26556d1ccf879ef7b122beeef960);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_134a26556d1ccf879ef7b122beeef960);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionUpdatedEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionUpdatedEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionUpdatedEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanModelRequestEndEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_87fa0cb24f156084d751cb015c923d88);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_87fa0cb24f156084d751cb015c923d88);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanModelRequestStartEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_bbb81df83a566cf2814346e63f686900);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_bbb81df83a566cf2814346e63f686900);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationEndEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_68b72308bf2917066fde4b492afa1489);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_68b72308bf2917066fde4b492afa1489);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_eca874ca0aca92a60a9f3961c3eeca4a);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_eca874ca0aca92a60a9f3961c3eeca4a);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationStartEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_b2ea6e7e043e35d36ec3c1599733882c);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_b2ea6e7e043e35d36ec3c1599733882c);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserCustomToolResultEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_be0c919b566c3ecfa243fcd814cb9d7c);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_be0c919b566c3ecfa243fcd814cb9d7c);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserDefineOutcomeEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserDefineOutcomeEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserDefineOutcomeEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserInterruptEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserInterruptEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserInterruptEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserMessageEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserMessageEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserMessageEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserToolConfirmationEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_47a3d32085b8900d70eebcf91501a8ea);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_47a3d32085b8900d70eebcf91501a8ea);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserToolResultEvent(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserToolResultEvent);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserToolResultEvent);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$PropertyInfo(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_PropertyInfo);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_PropertyInfo);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$TypeAlias(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_TypeAlias);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_TypeAlias);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$Union(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Union);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Union);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$__annotations__(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___annotations__);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___annotations__);
#endif
...
static PyObject *module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$__spec__(PyThreadState *tstate) {
#if 0
    PyObject *result;
    ...
    if (moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->ma_version_tag == dict_version) {
        ...
        result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___spec__);
        cache_value = result;
    }
#else
    static uint32_t dict_keys_version = 0xFFFFFFFF;
...
#else
    PyObject *result = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___spec__);
#endif
...
static PyCodeObject *code_objects_9ee25bfbd486841e46613041d63c6852;

static void createModuleCodeObjects(void) {
module_filename_obj = MAKE_RELATIVE_PATH(mod_consts.const_str_digest_4892cafcbff741f4695417859216a6af); CHECK_OBJECT(module_filename_obj);
code_objects_9ee25bfbd486841e46613041d63c6852 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts.const_str_digest_5defd43d0c78461018f49070fcc915ff, mod_consts.const_str_digest_5defd43d0c78461018f49070fcc915ff, NULL, NULL, 0, 0, 0);
}
#endif
...
static function_impl_code const function_table_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return Nuitka_Function_GetFunctionState(function, function_table_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
}
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events,
        function_qualname,
        function_index,
        code_object_desc,
        ...
        annotations,
        func_dict,
        function_table_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events,
        sizeof(function_table_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events) / sizeof(function_impl_code)
    );
}
...
static char const *module_full_name = "anthropic.types.beta.sessions.beta_managed_agents_stream_session_thread_events";
#endif

// Internal entry point for module code.
PyObject *module_code_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events");

    // Store the module for future use.
    module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events = module;

    moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events = MODULE_DICT(module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
    ...
    if (init_done == false) {
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events: Calling setupMetaPathBasedLoader().\n");
#endif
        setupMetaPathBasedLoader(tstate);
#if 0 >= 0
#ifdef _NUITKA_TRACE
        PRINT_STRING("anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events: Calling updateMetaPathBasedLoaderModuleRoot().\n");
#endif
        ...
        NUITKA_PRINT_TRACE("anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
#if _NUITKA_MODULE_MODE && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "anthropic.types.beta.sessions.beta_managed_agents_stream_session_thread_events" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif

    // PRINT_STRING("in initanthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events\n");
...
#ifdef _NUITKA_PLUGIN_DILL_ENABLED
    {
        ...
        if (loader_entry != NULL) {
            ...
            PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___name__);
    ...
    UPDATE_STRING_DICT0(
        moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events,
    ...
    CHECK_OBJECT(module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);

    // For deep importing of a module we need to have "__builtins__", so we set
    // it ourselves in the same way than CPython does. Note: This must be done
    // before the frame object is allocated, or else it may fail.

    if (GET_STRING_DICT_VALUE(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___builtins__, value);
    }

    PyObject *module_loader = Nuitka_Loader_New(loader_entry);
    UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___loader__, module_loader);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
        ...
        UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
...
struct Nuitka_FrameObject *frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___doc__, tmp_assign_source_1);
}
{
PyObject *tmp_assign_source_2;
tmp_assign_source_2 = module_filename_obj;
UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
}
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events = MAKE_MODULE_FRAME(code_objects_9ee25bfbd486841e46613041d63c6852, module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);

// Push the new frame as the currently active one, and we should be exclusively
// owning it.
pushFrameStackCompiledFrame(tstate, frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
assert(Py_REFCNT(frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events) == 2);
...
tmp_assattr_target_1 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$__spec__(tstate);
...
tmp_assattr_target_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$__spec__(tstate);
...
UPDATE_STRING_DICT0(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___cached__, tmp_assign_source_3);
}
{
PyObject *tmp_assign_source_4;
tmp_assign_source_4 = MAKE_DICT_EMPTY(tstate);
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___annotations__, tmp_assign_source_4);
}
{
...
if (PyModule_Check(tmp_import_name_from_1)) {
    tmp_assign_source_5 = IMPORT_NAME_OR_MODULE(
        ...
        (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events,
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Union, tmp_assign_source_5);
}
{
...
tmp_globals_arg_value_1 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_1 = Py_None;
tmp_fromlist_value_1 = mod_consts.const_tuple_str_plain_Annotated_str_plain_TypeAlias_tuple;
tmp_level_value_1 = const_int_0;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 4;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_Annotated, tmp_assign_source_7);
}
{
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_TypeAlias, tmp_assign_source_8);
}
goto try_end_1;
...
tmp_globals_arg_value_2 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 6;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_PropertyInfo, tmp_assign_source_9);
}
{
...
tmp_globals_arg_value_3 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_3 = Py_None;
tmp_fromlist_value_3 = mod_consts.const_tuple_str_plain_BetaManagedAgentsUserMessageEvent_tuple;
tmp_level_value_3 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 7;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserMessageEvent, tmp_assign_source_10);
}
{
...
tmp_globals_arg_value_4 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_4 = Py_None;
tmp_fromlist_value_4 = mod_consts.const_tuple_str_plain_BetaManagedAgentsAgentMessageEvent_tuple;
tmp_level_value_4 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 8;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMessageEvent, tmp_assign_source_11);
}
{
...
tmp_globals_arg_value_5 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_5 = Py_None;
tmp_fromlist_value_5 = mod_consts.const_tuple_str_plain_BetaManagedAgentsSessionErrorEvent_tuple;
tmp_level_value_5 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 9;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionErrorEvent, tmp_assign_source_12);
}
{
...
tmp_globals_arg_value_6 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_6 = Py_None;
tmp_fromlist_value_6 = mod_consts.const_tuple_str_plain_BetaManagedAgentsAgentThinkingEvent_tuple;
tmp_level_value_6 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 10;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentThinkingEvent, tmp_assign_source_13);
}
{
...
tmp_globals_arg_value_7 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_7 = Py_None;
tmp_fromlist_value_7 = mod_consts.const_tuple_str_plain_BetaManagedAgentsAgentToolUseEvent_tuple;
tmp_level_value_7 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 11;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolUseEvent, tmp_assign_source_14);
}
{
...
tmp_globals_arg_value_8 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_8 = Py_None;
tmp_fromlist_value_8 = mod_consts.const_tuple_str_plain_BetaManagedAgentsUserInterruptEvent_tuple;
tmp_level_value_8 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 12;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserInterruptEvent, tmp_assign_source_15);
}
{
...
tmp_globals_arg_value_9 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_9 = Py_None;
tmp_fromlist_value_9 = mod_consts.const_tuple_str_plain_BetaManagedAgentsSessionDeletedEvent_tuple;
tmp_level_value_9 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 13;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionDeletedEvent, tmp_assign_source_16);
}
{
...
tmp_globals_arg_value_10 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 14;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionUpdatedEvent, tmp_assign_source_17);
}
{
...
tmp_globals_arg_value_11 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 15;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserToolResultEvent, tmp_assign_source_18);
}
{
...
tmp_globals_arg_value_12 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_12 = Py_None;
tmp_fromlist_value_12 = mod_consts.const_tuple_str_plain_BetaManagedAgentsAgentToolResultEvent_tuple;
tmp_level_value_12 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 16;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentToolResultEvent, tmp_assign_source_19);
}
{
...
tmp_globals_arg_value_13 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
tmp_locals_arg_value_13 = Py_None;
tmp_fromlist_value_13 = mod_consts.const_tuple_str_plain_BetaManagedAgentsAgentMCPToolUseEvent_tuple;
tmp_level_value_13 = const_int_pos_1;
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 17;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolUseEvent, tmp_assign_source_20);
}
{
...
tmp_globals_arg_value_14 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 18;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsSessionStatusIdleEvent, tmp_assign_source_21);
}
{
...
tmp_globals_arg_value_15 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 19;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsUserDefineOutcomeEvent, tmp_assign_source_22);
}
{
...
tmp_globals_arg_value_16 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 20;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentCustomToolUseEvent, tmp_assign_source_23);
}
{
...
tmp_globals_arg_value_17 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 21;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_plain_BetaManagedAgentsAgentMCPToolResultEvent, tmp_assign_source_24);
}
{
...
tmp_globals_arg_value_18 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 22;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7bd78a3f07d54c8e773e97b2b33d4855, tmp_assign_source_25);
}
{
...
tmp_globals_arg_value_19 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 23;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_680985bd76c009f9f484b2ca1ee7179b, tmp_assign_source_26);
}
{
...
tmp_globals_arg_value_20 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 24;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_87fa0cb24f156084d751cb015c923d88, tmp_assign_source_27);
}
{
...
tmp_globals_arg_value_21 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 25;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_47a3d32085b8900d70eebcf91501a8ea, tmp_assign_source_28);
}
{
...
tmp_globals_arg_value_22 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 26;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_be0c919b566c3ecfa243fcd814cb9d7c, tmp_assign_source_29);
}
{
...
tmp_globals_arg_value_23 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 27;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_bbb81df83a566cf2814346e63f686900, tmp_assign_source_30);
}
{
...
tmp_globals_arg_value_24 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 28;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_53b65cba1e561c6df7f51f1093dca70d, tmp_assign_source_31);
}
{
...
tmp_globals_arg_value_25 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 29;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_a39975e914a6a86ba3153b197792b326, tmp_assign_source_32);
}
{
...
tmp_globals_arg_value_26 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 30;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_79208f99f42387dedaa503f910cf801e, tmp_assign_source_33);
}
{
...
tmp_globals_arg_value_27 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 31;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e0e15641e9785d45266c86e750f17f58, tmp_assign_source_34);
}
{
...
tmp_globals_arg_value_28 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 32;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_68b72308bf2917066fde4b492afa1489, tmp_assign_source_35);
}
{
...
tmp_globals_arg_value_29 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 33;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_8aa8484df48f880159babc856f073325, tmp_assign_source_36);
}
{
...
tmp_globals_arg_value_30 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 34;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_7c5e88ab7f33db0dd8ffb0cc94d6c2ac, tmp_assign_source_37);
}
{
...
tmp_globals_arg_value_31 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 35;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_b2ea6e7e043e35d36ec3c1599733882c, tmp_assign_source_38);
}
{
...
tmp_globals_arg_value_32 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 36;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_e328354439fe86c13e6c5cffe6a79707, tmp_assign_source_39);
}
{
...
tmp_globals_arg_value_33 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 37;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_eca874ca0aca92a60a9f3961c3eeca4a, tmp_assign_source_40);
}
{
...
tmp_globals_arg_value_34 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 40;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_134a26556d1ccf879ef7b122beeef960, tmp_assign_source_41);
}
{
...
tmp_globals_arg_value_35 = (PyObject *)moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 43;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_80411456df379e8767e34326f63b4233, tmp_assign_source_42);
}
{
PyObject *tmp_assign_source_43;
tmp_assign_source_43 = MAKE_LIST1(tstate, mod_consts.const_str_digest_1c85da38dd09ccf517e65697df6a701b);
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)const_str_plain___all__, tmp_assign_source_43);
}
{
...
tmp_expression_value_1 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$Annotated(tstate);
...
tmp_expression_value_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$Union(tstate);
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserMessageEvent(tstate);
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserInterruptEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserToolConfirmationEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserCustomToolResultEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentCustomToolUseEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMessageEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThinkingEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMCPToolUseEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentMCPToolResultEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentToolUseEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentToolResultEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadMessageReceivedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadMessageSentEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsAgentThreadContextCompactedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionErrorEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusRescheduledEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusRunningEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusIdleEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionStatusTerminatedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadCreatedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationStartEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationEndEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanModelRequestStartEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanModelRequestEndEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserDefineOutcomeEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionDeletedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusRunningEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusIdleEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusTerminatedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsUserToolResultEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionThreadStatusRescheduledEvent(tstate);
assert(!(tmp_tuple_element_2 == NULL));
PyTuple_SET_ITEM0(tmp_subscript_value_2, 31, tmp_tuple_element_2);
tmp_tuple_element_2 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$BetaManagedAgentsSessionUpdatedEvent(tstate);
if (unlikely(tmp_tuple_element_2 == NULL)) {
...
tmp_called_value_1 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$PropertyInfo(tstate);
...
frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame.f_lineno = 85;
...
UPDATE_STRING_DICT1(moduledict_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, (Nuitka_StringObject *)mod_consts.const_str_digest_1c85da38dd09ccf517e65697df6a701b, tmp_assign_source_44);
}
{
PyObject *tmp_ass_subvalue_1;
PyObject *tmp_ass_subscribed_1;
PyObject *tmp_ass_subscript_1;
tmp_ass_subvalue_1 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$TypeAlias(tstate);
...
tmp_ass_subscribed_1 = module_var_accessor_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events$__annotations__(tstate);
...
tmp_ass_subscript_1 = mod_consts.const_str_digest_1c85da38dd09ccf517e65697df6a701b;
...

{
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, exception_lineno);
        SET_EXCEPTION_STATE_TRACEBACK(&exception_state, exception_tb);
    } else if (exception_tb->tb_frame != &frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events, exception_lineno);
        SET_EXCEPTION_STATE_TRACEBACK(&exception_state, exception_tb);
    }
}
...
assertFrameObject(frame_frame_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
...
frame_no_exception_1:;
    ...
    PGO_onModuleExit("anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events", false);

#if _NUITKA_MODULE_MODE && 0
    {
        PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "anthropic.types.beta.sessions.beta_managed_agents_stream_session_thread_events" "-postLoad");
        if (post_load == NULL) {
            return NULL;
        }
    }
    ...
    Py_INCREF(module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events);
    return module_anthropic$types$beta$sessions$beta_managed_agents_stream_session_thread_events;
