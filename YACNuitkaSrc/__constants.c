...
PyObject *global_constants[109] = {0};
...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    Nuitka_SysSetObject(
        "executable",
#if !_NUITKA_STANDALONE_MODE
        global_constants[107]
#else
        getStandaloneSysExecutablePath(global_constants[107])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, Nuitka_PyInt_FromLong(0));
...
# endif
    ...
    setDistributionsMetadata(tstate, global_constants[108]);
}
