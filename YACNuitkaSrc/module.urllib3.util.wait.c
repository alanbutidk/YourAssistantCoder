...
assert(mod_consts_hash[0] == DEEP_HASH(tstate, mod_consts.const_str_digest_d47e372f7598b75180e9e0f6f1e0d266));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_d47e372f7598b75180e9e0f6f1e0d266);
...
assert(mod_consts_hash[2] == DEEP_HASH(tstate, mod_consts.const_str_plain_select));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_select);
assert(mod_consts_hash[3] == DEEP_HASH(tstate, mod_consts.const_str_plain_POLLIN));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_POLLIN);
assert(mod_consts_hash[4] == DEEP_HASH(tstate, mod_consts.const_str_plain_POLLOUT));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_POLLOUT);
assert(mod_consts_hash[5] == DEEP_HASH(tstate, mod_consts.const_str_plain_poll));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_poll);
assert(mod_consts_hash[6] == DEEP_HASH(tstate, mod_consts.const_dict_a5163cc7534489db21dded1078e6aa1b));
CHECK_OBJECT_DEEP(mod_consts.const_dict_a5163cc7534489db21dded1078e6aa1b);
assert(mod_consts_hash[7] == DEEP_HASH(tstate, mod_consts.const_str_plain_do_poll));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_do_poll);
assert(mod_consts_hash[8] == DEEP_HASH(tstate, mod_consts.const_str_digest_d4b4230713465b3db317e462a98dc2e6));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_d4b4230713465b3db317e462a98dc2e6);
assert(mod_consts_hash[9] == DEEP_HASH(tstate, mod_consts.const_int_pos_1000));
CHECK_OBJECT_DEEP(mod_consts.const_int_pos_1000);
assert(mod_consts_hash[10] == DEEP_HASH(tstate, mod_consts.const_str_plain_poll_obj));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_poll_obj);
assert(mod_consts_hash[11] == DEEP_HASH(tstate, mod_consts.const_tuple_int_0_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_int_0_tuple);
assert(mod_consts_hash[12] == DEEP_HASH(tstate, mod_consts.const_tuple_type_AttributeError_type_OSError_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_type_AttributeError_type_OSError_tuple);
assert(mod_consts_hash[13] == DEEP_HASH(tstate, mod_consts.const_str_plain__have_working_poll));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain__have_working_poll);
assert(mod_consts_hash[14] == DEEP_HASH(tstate, mod_consts.const_str_plain_poll_wait_for_socket));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_poll_wait_for_socket);
assert(mod_consts_hash[15] == DEEP_HASH(tstate, mod_consts.const_str_plain_wait_for_socket));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_wait_for_socket);
assert(mod_consts_hash[16] == DEEP_HASH(tstate, mod_consts.const_str_plain_select_wait_for_socket));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_select_wait_for_socket);
assert(mod_consts_hash[17] == DEEP_HASH(tstate, mod_consts.const_tuple_str_plain_read_str_plain_timeout_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_str_plain_read_str_plain_timeout_tuple);
assert(mod_consts_hash[18] == DEEP_HASH(tstate, mod_consts.const_str_digest_1dcb6343172673d8611eeb5f6284e6ec));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_1dcb6343172673d8611eeb5f6284e6ec);
assert(mod_consts_hash[19] == DEEP_HASH(tstate, mod_consts.const_tuple_str_plain_write_str_plain_timeout_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_str_plain_write_str_plain_timeout_tuple);
assert(mod_consts_hash[20] == DEEP_HASH(tstate, mod_consts.const_str_digest_66f9c8fba41fe2db2f8687b18b0dcc81));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_66f9c8fba41fe2db2f8687b18b0dcc81);
...
assert(mod_consts_hash[24] == DEEP_HASH(tstate, mod_consts.const_str_plain_socket));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_socket);
assert(mod_consts_hash[25] == DEEP_HASH(tstate, mod_consts.const_str_plain_wait_for_read));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_wait_for_read);
assert(mod_consts_hash[26] == DEEP_HASH(tstate, mod_consts.const_str_plain_wait_for_write));
CHECK_OBJECT_DEEP(mod_consts.const_str_plain_wait_for_write);
assert(mod_consts_hash[27] == DEEP_HASH(tstate, mod_consts.const_tuple_false_false_none_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_false_false_none_tuple);
assert(mod_consts_hash[28] == DEEP_HASH(tstate, mod_consts.const_dict_555b8a9c12d8c080aaf2552f9014dadd));
CHECK_OBJECT_DEEP(mod_consts.const_dict_555b8a9c12d8c080aaf2552f9014dadd);
assert(mod_consts_hash[29] == DEEP_HASH(tstate, mod_consts.const_dict_6e59d149b5de9bf1c65a16b0cdfcaef6));
...
assert(mod_consts_hash[31] == DEEP_HASH(tstate, mod_consts.const_dict_ae1cc9d0f4d9353353216a0ba5d1af9d));
CHECK_OBJECT_DEEP(mod_consts.const_dict_ae1cc9d0f4d9353353216a0ba5d1af9d);
assert(mod_consts_hash[32] == DEEP_HASH(tstate, mod_consts.const_str_digest_ba4902da016df054e34a5eb31317683f));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_ba4902da016df054e34a5eb31317683f);
assert(mod_consts_hash[33] == DEEP_HASH(tstate, mod_consts.const_str_digest_2793acd2a9eb309196b14c7196b7f975));
CHECK_OBJECT_DEEP(mod_consts.const_str_digest_2793acd2a9eb309196b14c7196b7f975);
assert(mod_consts_hash[34] == DEEP_HASH(tstate, mod_consts.const_tuple_str_plain_poll_obj_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_str_plain_poll_obj_tuple);
assert(mod_consts_hash[35] == DEEP_HASH(tstate, mod_consts.const_tuple_str_plain_t_str_plain_poll_obj_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_str_plain_t_str_plain_poll_obj_tuple);
assert(mod_consts_hash[36] == DEEP_HASH(tstate, mod_consts.const_tuple_d72f9bbdc4d933204f83f3253234107f_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_d72f9bbdc4d933204f83f3253234107f_tuple);
assert(mod_consts_hash[37] == DEEP_HASH(tstate, mod_consts.const_tuple_9f64bbb63fef08e9a4e8e990363fe01c_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_9f64bbb63fef08e9a4e8e990363fe01c_tuple);
assert(mod_consts_hash[38] == DEEP_HASH(tstate, mod_consts.const_tuple_str_plain_sock_str_plain_timeout_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_str_plain_sock_str_plain_timeout_tuple);
assert(mod_consts_hash[39] == DEEP_HASH(tstate, mod_consts.const_tuple_7db28342f71aeff3654aac9759b7c4f6_tuple));
CHECK_OBJECT_DEEP(mod_consts.const_tuple_7db28342f71aeff3654aac9759b7c4f6_tuple);
}
#endif
...
tmp_assattr_target_1 = module_var_accessor_urllib3$util$wait$__spec__(tstate);
...
tmp_assattr_target_2 = module_var_accessor_urllib3$util$wait$__spec__(tstate);
...
UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_annotations, tmp_assign_source_4);
}
{
PyObject *tmp_assign_source_5;
...
UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_select, tmp_assign_source_5);
}
{
PyObject *tmp_assign_source_6;
...
UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_socket, tmp_assign_source_6);
}
...
UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_partial, tmp_assign_source_7);
}
{
PyObject *tmp_assign_source_8;
tmp_assign_source_8 = MAKE_LIST2(tstate, mod_consts.const_str_plain_wait_for_read,mod_consts.const_str_plain_wait_for_write);
UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)const_str_plain___all__, tmp_assign_source_8);
}
{
PyObject *tmp_assign_source_9;
...
tmp_assign_source_9 = MAKE_FUNCTION_urllib3$util$wait$$$function__1_select_wait_for_socket(tstate, tmp_defaults_1, tmp_annotations_1);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_select_wait_for_socket, tmp_assign_source_9);
}
{
PyObject *tmp_assign_source_10;
...
tmp_assign_source_10 = MAKE_FUNCTION_urllib3$util$wait$$$function__2_poll_wait_for_socket(tstate, tmp_defaults_2, tmp_annotations_2);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_poll_wait_for_socket, tmp_assign_source_10);
}
{
...
tmp_assign_source_11 = MAKE_FUNCTION_urllib3$util$wait$$$function__3__have_working_poll(tstate, tmp_annotations_3);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain__have_working_poll, tmp_assign_source_11);
}
{
...
tmp_assign_source_12 = MAKE_FUNCTION_urllib3$util$wait$$$function__4_wait_for_socket(tstate, tmp_defaults_3, tmp_annotations_4);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_wait_for_socket, tmp_assign_source_12);
}
{
...
tmp_assign_source_13 = MAKE_FUNCTION_urllib3$util$wait$$$function__5_wait_for_read(tstate, tmp_defaults_4, tmp_annotations_5);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_wait_for_read, tmp_assign_source_13);
}
{
...
tmp_assign_source_14 = MAKE_FUNCTION_urllib3$util$wait$$$function__6_wait_for_write(tstate, tmp_defaults_5, tmp_annotations_6);

UPDATE_STRING_DICT1(moduledict_urllib3$util$wait, (Nuitka_StringObject *)mod_consts.const_str_plain_wait_for_write, tmp_assign_source_14);
}
