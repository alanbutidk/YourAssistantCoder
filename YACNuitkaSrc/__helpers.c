...
PyObject *CALL_FUNCTION_WITH_ARGS12(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 12, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 12);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 12);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS13(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 13, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 13);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 13);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
...
PyObject *CALL_FUNCTION_WITH_ARGS19(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 19 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 19);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 19);
            ...
            if (function->m_args_simple && 19 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 19);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 19, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 19);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 19, NULL);
#endif
        CHECK_OBJECT_X(result);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 19);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 19);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS19(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS52(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 52); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 52 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 52);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 52);
            ...
            if (function->m_args_simple && 52 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 52);
            }
        ...
        if (!(flags & METH_VARARGS)) {
            ...
            assert(func != NULL);
            result = func(called, args, 52, NULL);
            ...
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 52);
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 52, NULL);
#else
            PyObject *pos_args = MAKE_TUPLE(tstate, args, 52);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 52, NULL);
#endif
        CHECK_OBJECT_X(result);
        ...
        if (type->tp_call == PyType_Type.tp_call) {
            ...
            if (called_type->tp_new == PyBaseObject_Type.tp_new) {
                ...
                pos_args = MAKE_TUPLE(tstate, args, 52);
                obj = called_type->tp_new(called_type, pos_args, NULL);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 52);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS52(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 52, NULL);
...
PyObject *CALL_FUNCTION_WITH_POS_ARGS12(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_POS_ARGS12(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_POS_ARGS13(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_POS_ARGS13(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS12_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 12); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(tstate, function, args, 12, kw_values, kw_names);
        ...
        if (likely(func != NULL)) {
            NUITKA_DYNAMIC_ARRAY_DECL(vectorcall_args, PyObject *, 12 + kwargs_count);

            memcpy(vectorcall_args, args, 12*sizeof(PyObject *));
            memcpy(&vectorcall_args[12], kw_values, kwargs_count*sizeof(PyObject *));
...
PyObject *CALL_METHOD_WITH_ARGS52(PyThreadState *tstate, PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && Nuitka_Descr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS52(tstate, called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS52(tstate, descr, args)
;
            Py_DECREF(descr);
            return result;
        }
        ...
        // so we need not release it in this branch.
        if (called_object != NULL) {
            return CALL_FUNCTION_WITH_ARGS52(tstate, called_object, args)
;
        }
        ...
        if (called_object != NULL) {
            ...
            if (descr_get == Nuitka_Function_Type.tp_descr_get) {
                ...
                PyObject *result = CALL_FUNCTION_WITH_ARGS52(tstate, method, args)
;
                Py_DECREF(method);
                return result;
            } else {
